...
const NoteList = ({currentView, notes, selectedNoteID, searchQuery, setSearchQuery, selectNote}) => {

    return (
        <div className="flex flex-col items-start w-72 px-3 py-5 gap-5 border-r-2 border-slate-700 text-slate-100">
            <p className="text-xl font-bold">{currentView==='all'? "All Notes": currentView}</p>
